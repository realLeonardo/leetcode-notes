...
class Solution {
   ...
   * 4. 遍历插入
   */
  public static reorganizeString = (s: string): string => {
...
// NOTE: 简单的测试用例
console.log(Solution.reorganizeString("") === "");
console.log(Solution.reorganizeString("aab") === "aba");
console.log(Solution.reorganizeString("babaa") === "ababa");
console.log(Solution.reorganizeString("abbabbaaab") === "ababababab");
console.log(Solution.reorganizeString("xogbmcjjie") === "jgjibmcoex");
console.log(
  Solution.reorganizeString("ogccckcwmbmxtsbmozli") === "cocgcickmlmsmtbwbxoz",
);
